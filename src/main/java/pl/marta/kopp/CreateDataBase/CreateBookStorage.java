...
public class CreateBookStorage {
    public static void create(BookStorage bookStorage, AuthorStorage authorStorage){
        ...
        authors.add(author);
        Book book = new Book("Akademia Pana Kleksa",authors,true);
        ...
        Book book1 = new Book("W Pustyni i w Puszczy",authors1,true);
        ...
        Book book2 = new Book("Dziady",authors2,true);
        ...
        Book book3 = new Book("Wiersze",authors3,true);
        ...
        Book book4 = new Book("Katarynka",authors4,true);
        ...
        Book book5 = new Book("Zemsta",authors5,true);
